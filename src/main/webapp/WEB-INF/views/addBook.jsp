		...
		<form action="addBook" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<label class="form-label">Category</label> <input type="text"
					...
					placeholder="Eg: Fiction, Science" required>
			</div>
			...
			<c:if test="${msg == 'book inserted successfully'}">
				<p style="color: green">book inserted successfully</p>
			</c:if>
			<c:if test=""></c:if>
			<c:if test="${msg == 'book inserted successfully'}">
				<p style="color: red">book not inserted successfully</p>
			</c:if>
