...
<div class="update-book-card">
    ...
    <form action="updateBook" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="id" class="form-control" placeholder="Enter Book ID" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="category" class="form-control" placeholder="Eg: Fiction, Science">
        </div>

        <div class="mb-3">
            <label class="form-label">Description</label>
            <textarea name="description" class="form-control" rows="3" placeholder="Update description"></textarea>
        </div>
